...
public class Woda_robot extends TeamRobot implements Serializable {

    public static String FICHERO_REGLAS = "woda/reglas/reglas_robot.drl";
   ...
   // public List<WaveBullet> waves = new ArrayList<WaveBullet>();
    ...
    public void run() {
    	...
    	// Define o campo de batalha como um ret̢ngulo
        _fieldRect = new Rectangle2D.Double(50, 50, getBattleFieldWidth() - 100, getBattleFieldHeight() - 100);
        // Cria uma lista com as localiza̵̤es recentes
        ...
        // Hacer que movimiento de tanque, radar y ca̱on sean independientes
    ...
    private void crearBaseConocimiento() {
        String ficheroReglas = System.getProperty("robot.reglas", Woda_robot.FICHERO_REGLAS);

        DEBUG.mensaje("crear base de conocimientos");
        kbuilder = KnowledgeBuilderFactory.newKnowledgeBuilder();
        
        DEBUG.mensaje("cargar reglas desde "+ficheroReglas);
        kbuilder.add(ResourceFactory.newClassPathResource(ficheroReglas, Woda_robot.class), ResourceType.DRL);
    ...
    private Vector<Accion> recuperarAcciones() {
        ...
        for (QueryResultsRow resultado : ksession.getQueryResults(Woda_robot.CONSULTA_ACCIONES)) {
